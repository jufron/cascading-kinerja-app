...
$(document).ready(function() {
    const tableLabKomputer = $('#lab-komputer-table');

    const datatable = tableLabKomputer.DataTable({
        serverSide: true,
        processing: true,
        ajax: {
            url: tableLabKomputer.attr('data-url'),
            data: function(d) {
                // * prodi
        ...
        columns: [
            ...
            { data: 'Nama Mahasiswa', name: 'Nama Mahasiswa', searchable: true },
