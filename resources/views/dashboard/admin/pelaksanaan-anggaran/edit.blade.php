                    ...
                    <div class="col-md-6">
                        <x-dashboard.subComponents.input-select name="kinerja_id" label="Nama Lengkap">
                            ...
                            @foreach ($kinerja as $krj)
                                <option value="{{ $krj->id }}" {{ $pelaksanaanAnggaran->kinerja_id == $krj->id ? 'selected' : '' }}>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <x-dashboard.subComponents.input
                                ...
                                type="text"
                                valueData="{{ $pelaksanaanAnggaran->kinerja->sasaran_strategis }}"
                                disable="true"
                            />
                        </div>
                        ...
                        <div class="col-md-4">
                            <x-dashboard.subComponents.input
                                ...
                                type="text"
                                valueData="{{ $pelaksanaanAnggaran->kinerja->sasaran_strategis_individu }}"
                                disable="true"
                            />
                        </div>
                        ...
                        <div class="col-md-4">
                            <x-dashboard.subComponents.input
                                ...
                                type="text"
                                valueData="{{ $pelaksanaanAnggaran->kinerja->indikator_kinerja_individu }}"
                                disable="true"
                            />
                        </div>
                        {{-- ? target --}}
                        <div class="col-md-3">
                            <x-dashboard.subComponents.input
                                ...
                                name="target"
                                type="text"
                                valueData="{{ $pelaksanaanAnggaran->kinerja->target }}"
                                disable="true"
                            />
                        </div>
                    </div>
